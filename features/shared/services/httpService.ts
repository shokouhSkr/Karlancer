...
const customAxios = axios.create({
	baseURL: BASE_URL,
	withCredentials: true, // Now each cookie that presents in the user browser, sends to the backend automatically, and the rest is handled in the backend (cookie type: http-only)
});
